...
|--------------------|---------|---------|---------|--------------|---------------|---|
| Board of Governers | Provide oversight and strategic direction to DES. | Mark Bennett | ?? | [board-of-governors](https://groups.google.com/a/devedmonton.com/d/forum/board-of-governors) | #dev-edmonton-society | bi-monthly, per calendar |
| Event Recording    | Allow event hosts to record and share events. | Aaron Yong | ?? | [event-recording-working-group](https://groups.google.com/a/devedmonton.com/d/forum/event-recording-working-group) | #event-recording | none |
| Meetup Support | Provide resources, materials, and services to make running meetups and events easier. | Mark | ??  | [meetup-support-working-group](https://groups.google.com/a/devedmonton.com/d/forum/meetup-support-working-group)| ?? | bi-monthly, per calendar |
| Finance | Control and report on DES finances | Estyn Edwards | ?? | [finance-working-group](https://groups.google.com/a/devedmonton.com/d/forum/finance-working-group) | ?? | monthly |
| Slack | Handle defining Slack Code of Conduct, and performing moderation, discipline and a healthy community. | Ashia | ?? | [slack-working-group](https://groups.google.com/a/devedmonton.com/d/forum/slack-working-group) | ?? | TBD |
| Website & Media | Manage DES social media and web properties | Aaron Yong | ?? | [web-working-group](https://groups.google.com/a/devedmonton.com/d/forum/web-working-group) | ?? | TBD |
