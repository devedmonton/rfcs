...
This propsal is a draft with outstanding issues to address. The Society is currently implementing this process and looking for feedback from key stakeholders and Working Group Champions. Send feedback to mark@devedmonton.com, or [create a pull request and file issues on GitHub](https://github.com/devedmonton/rfcs).
