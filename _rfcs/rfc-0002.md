...
* Working groups should have budgets. How are these budgets set and managed? Who approves expenses?
...
* [Example Working Group Charter from WASM](https://github.com/WebAssembly/WASI/blob/master/Charter.md)
