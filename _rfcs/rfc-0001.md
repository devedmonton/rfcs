...
A Request For Collaboration, or RFC, is a document used by the Dev Edmonton Society to develop and share process, standards, and best practices amongst our members and the broader community.

This document describes in detail the motivation for the RFC process, what an RFC is, and how they're created and shared. It also contemplates alternative processes and links to other pertinent reference material.
...
It's the hope that during this process the RFC is shaped and polished through constructive feedback and collaborative with the community, and with the support of a Working Group, until concensus can be found and an optimal RFC is realized.
...
[![](./rfc-0001/statuses.svg)](https://mermaid-js.github.io/mermaid-live-editor/#/edit/eyJjb2RlIjoic3RhdGVEaWFncmFtXG5cdFsqXSAtLT4gUHJvcG9zZWRcblx0UHJvcG9zZWQgLS0-IERyYWZ0XG4gIERyYWZ0IC0tPiBBY2NlcHRlZFxuICBBY2NlcHRlZCAtLT4gWypdXG4gIFByb3Bvc2VkIC0tPiBXaXRoZHJhd25cbiAgRHJhZnQgLS0-IFdpdGhkcmF3blxuICBXaXRoZHJhd24gLS0-IFsqXVxuXHRcdFx0XHRcdCIsIm1lcm1haWQiOnsidGhlbWUiOiJkZWZhdWx0In0sInVwZGF0ZUVkaXRvciI6ZmFsc2V9)
