...
Once your ready to champion your proposal with a Working Group, send a message to the Workingr Group mailing list requesting a vote on accepting your RFC into draft. Contact the Working Group Steward or a Board Member if you need help doing this. Working Group members then have two weeks to vote on the RFC at which point it will either be accepted or not.
