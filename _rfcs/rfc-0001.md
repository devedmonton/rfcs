...
Once you're ready to champion your proposal with a Working Group create your pull request, or remove the draft flag from your pull request, and ask for a review. An RFC maintainer will then review your pull request for formatting and style, then assign an RFC number and merge your RFC.
...
Accepted RFCs become the accepted position of the Dev Edmonton Society, and in the case of processes, decisions, or best practices should be implemented by the Working Group that created them.
